...
sudo rsync -a --no-owner --no-group --remove-source-files $WORKING_DIRECTORY/diba-bc-installer/var/lib/proxmox-installer/ $WORKING_DIRECTORY/diba-bc-installer/var/lib/diba-bc-installer/
...
# sudo rsync -a --no-owner --no-group --remove-source-files $ISO_SOURCE/boot/tmp/.pve-cd-id.txt $ISO_SOURCE/boot/tmp/.diba-bc-cd-id.txt
...
# MANAGER_NAME=$(find . -name "*pve-manager*" -print)
...
sudo rm -rvf $ISO_SOURCE/pve-installer.squashfs
...
# sudo rsync -a --no-owner --no-group --remove-source-files $ISO_SOURCE/.pve-cd-id.txt $ISO_SOURCE/.diba-bc-cd-id.txt

# Final steps
cd $WORKING_DIRECTORY
sudo rm -rvf diba-bc-installer.squashfs
sudo rm -rvf pve-base.squashfs
